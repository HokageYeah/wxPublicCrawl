...
# ============================================================================
# PyInstaller 配置文件
# 用途：将 Python 桌面应用打包为独立可执行文件
# 平台：macOS (.app) / Windows (.exe)
# ============================================================================
...
exe = EXE(
    ...
    entitlements_file=None,    # macOS 权限文件（None = 无）
)
...
coll = COLLECT(
    ...
    # 输出目录名称
    # --------------------------------------------------------------------
    name='WxPublicCrawler',  # 输出目录：dist/WxPublicCrawler/
)
...
if is_mac:
    app = BUNDLE(
        ...
        # 应用包名称
        # --------------------------------------------------------------------
        name='WxPublicCrawler.app',  # 最终输出：dist/WxPublicCrawler.app
        ...
        info_plist={
            ...
            # 其他可选配置：
            # 'CFBundleName': 'WxPublicCrawler',  # 应用名称
            # 'CFBundleDisplayName': '公众号爬虫助手',  # 显示名称（支持中文）
...
# macOS:
#   dist/
#   ├── WxPublicCrawler.app/          ← 双击运行
#   │   └── Contents/
#   │       ├── MacOS/WxPublicCrawler
#   │       ├── Resources/
#   │       └── Info.plist
#   └── WxPublicCrawler/              ← 终端调试用
#       ├── _internal/
#       └── WxPublicCrawler
#
# Windows:
