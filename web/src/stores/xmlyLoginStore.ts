    ...
    startPolling() {
      ...
      this.pollingInterval = window.setInterval(async () => {
        try {
          ...
          // 检查二维码状态
          const statusResponse = await xmlyService.checkQrcodeStatus({
            qrId: this.qrId,
          });
          ...
          // 扫码成功
            ...
            statusResponse.scanned &&
            statusResponse.user_info
          ) {
            console.log("✓ 用户扫码成功");
            ...
            this.isLoggedIn = true;
            this.currentStep = XmlyLoginStep.LOGIN_SUCCESS;
            this.token = statusResponse.token || "";
            this.cookies = statusResponse.cookies || {};
